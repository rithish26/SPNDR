...
class Dsheet extends StatefulWidget {
  String refid = "";
  String name = "";
  Dsheet({required this.refid, required this.name});

  @override
  _DsheetState createState() => _DsheetState();
}

class _DsheetState extends State<Dsheet> with TickerProviderStateMixin {
